...
const cardData = [
  ...
  { totalUsers: 7, title: 'Faktor', avatars: ['5.png', '6.png', '7.png', '8.png', '1.png', '2.png', '3.png'] },
  { totalUsers: 5, title: 'Użytkownicy', avatars: ['4.png', '5.png', '6.png', '7.png', '8.png'] },
]
...
const RolesCards = () => {
  ...
  const [dialogTitle, setDialogTitle] = useState('Nadawanie')
        ...
        <Card>
          <CardContent>
            <Box sx={{ mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant='body2'>W sumie {item.totalUsers} użytkowników</Typography>
              <AvatarGroup
                max={4}
                sx={{
            ...
            <Grid item xs={7}>
              <CardContent>
                <Box sx={{ textAlign: 'right' }}>
                  ...
                  <Typography variant='body2'>Stwórz Nową Role w Systemie</Typography>
                </Box>
              </CardContent>
            </Grid>
          </Grid>
                ...
                <TableHead>
                  <TableRow>
                    <TableCell sx={{ pl: '0 !important' }}>
                      ...
                      >
                       Pełne Uprawnienia
                        <Tooltip placement='top' title='Daje pełne uprawnienia do systemu'>
                  ...
                  {rolesArr.map((i, index) => {
                    return (
                      <TableRow key={index} sx={{ '& .MuiTableCell-root:first-of-type': { pl: 0 } }}>
                        ...
                        <TableCell>
                          <FormControlLabel control={<Checkbox size='small' />} label='Zaznacz' />
                        </TableCell>
                      </TableRow>
                    )
                  })}
