...
const UserViewSecurity = () => {
  ...
  return (
    <Fragment>
      <Card sx={{ mb: 6 }}>
        <CardHeader title='Zmiana Hasła' titleTypographyProps={{ variant: 'h6' }} />
        <CardContent>
          <Alert icon={false} severity='warning' sx={{ mb: 4 }}>
            <AlertTitle sx={{ mb: theme => `${theme.spacing(1)} !important` }}>
              Upewnij się że wymagania dotyczące hasła są spełnione
            </AlertTitle>
            Minimum 8 znaków, w tym znak specjalny i liczba
          </Alert>
            ...
            <Grid container spacing={2.5}>
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth size='small'>
                  <InputLabel htmlFor='user-view-security-new-password'>Nowe Hasło</InputLabel>
                  <OutlinedInput
                    label='New Password'
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth size='small'>
                  <InputLabel htmlFor='user-view-security-confirm-new-password'>Potwierdź nowe hasło</InputLabel>
                  <OutlinedInput
      ...
      <Card sx={{ mb: 6 }}>
        <CardHeader
          ...
          subheader='Zabezpiecz swoje konto dodatkową metodą uwierzytelnienia'
        />
        <CardContent>
          ...
          Weryfikacja dwuetapowa zapewnia drugą warstwę zabezpieczeń związanych z logowaniem.{' '}
