...
const UserViewRight = ({ invoiceData }) => {
  ...
  return (
    <TabContext value={value}>
      ...
      >
        <Tab value='overview' label='Wnioski' icon={<AccountOutline sx={{ fontSize: '18px' }} />} />
        <Tab value='security' label='Bezpieczeństwo' icon={<LockOutline sx={{ fontSize: '18px' }} />} />
        <Tab value='notification' label='Powiadomienia' icon={<BellOutline sx={{ fontSize: '18px' }} />} />
      </TabList>
      <Box sx={{ mt: 3 }}>
